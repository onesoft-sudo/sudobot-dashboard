    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className='text-center mx-5 ml-0'>
                ...
                <a href={`${githubRepo}/releases`} target="_blank" rel='noreferrer'><ThemeButton className='px-3 md:px-5 py-2 md:py-3 w-[100%] md:w-auto block md:inline-block mx-3' size='large' variant='outlined'>Download Latest Release</ThemeButton></a>
            </div>
        </div>
    );
}
