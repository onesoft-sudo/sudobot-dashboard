        ...
        <Card>
            <CardHeader>
                <div className="flex items-center justify-between w-[100%] relative">
                    ...
                    <div>
                        <Switch
                            defaultChecked={config?.antispam?.enabled ?? false}
            ...
            <CardBody>
                ...
                <div className="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        <TextField
                            type="number"
                            label="Timeframe"
                            defaultValue={config?.antispam?.timeframe ?? 0}
                            {...register("antispam.timeframe", {
                                ...
                                onChange(event) {
                                    setState(state => ({
                                        ...state,
                                        timeframe: parseInt(event.target.value),
                                    }));
                                },
                            })}
                        />
                ...
                <FormHelperText>
                    {!isNaN(state.limit) && !isNaN(state.timeframe) && (
                        <>
                            ...
                            {formatDuration(state.timeframe)} will be considered
                            as spam.
                        </>
                    )}
                </FormHelperText>
                ...
                <TextField
                    ...
                    {...register("antispam.action", {
                        required: {
                            value: true,
                            message: "Please provide an action to take!",
                        },
                        onChange(event) {
                            setState(state => ({
                                ...state,
                ...
                {state.action.startsWith("mute") && (
                    <>
                        ...
                        <TextField
                            ...
                            label="Mute Duration"
                            defaultValue={
                                config?.antispam?.mute_duration ?? 3_600_000
                            }
