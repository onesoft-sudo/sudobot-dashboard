    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="h-[200px] w-[200px] md:h-[600px] md:w-[600px] bg-[linear-gradient(45deg,#007bff,#19dafa)] blur-[130px] md:blur-[350px] top-[100px] md:top-0 left-[50%] translate-x-[-50%] md:translate-x-0 md:left-0 absolute z-[0] hidden md:block"></div>
