import DiscordVerification from "@/components/Verification/DiscordVerification";
...
export default function Page({ searchParams }: { searchParams: Record<string, string> }) {
    ...
    return (
        <div className="flex min-h-[80vh] flex-col items-center justify-center py-10 md:py-20">
            <h1 className="pb-3 text-center text-3xl lg:text-4xl">Verify with Discord</h1>

            <div className="relative mt-5 flex min-h-full w-full flex-col items-center justify-center text-center">
                <DiscordVerification code={code} token={token} />
            </div>
        </div>
    );
}
